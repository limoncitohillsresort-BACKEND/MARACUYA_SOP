...
10.  EMG  Emergency and Safety. Flood and road, hurricane, fire, medical evacuation, power-out.
11.  BIO  Biodynamic systems and the Bible of the Land.
12.  GST  Guest experience and check-in.
13.  INF  Infrastructure maintenance. Power, well-cistern, pools.
14.  INF/BIO  Pool maintenance. Biology and hard system.
15.  WST  Waste to resource cycle.
16.  HSK  Villa and apartment cleaning protocol and schedule.
17.  GST/HRC  House rules and minimum standards.
18.  MNT  MacGyver quick-fix handbook.
19. Remaining departments, Grade 1 to Grade 4.
...
12. Generate as many SOPs as possible. No interlock inside them. interlock_pending: true.
13. Run the review process. interlock_updater.py scans the repo and prints version 1 of the manuals
   with interlock written on the HEAD covers.
14. The library grows over the year. New SOPs are added with interlock_pending: true.
15. At the next review, internal scan every 6 months, full new edition every year, rerun the script.
...
16. New printed editions are produced every year.
...
2.6 Images
Always include descriptive alt text: ![Dashboard screenshot](path/to/image.png)
Add titles for tooltips: ![Screenshot](img.png "Main dashboard view")
Use linked images for clickable thumbnails: [![Demo](thumb.jpg)](video-url)
2.7 Tables
...
![Image alt text](path/to/image.png "Optional title")
