...
┌─────────────────────────────────────────────────────────────┐
│  HRC-1.02.11                                                  │
│  Puesto: Encargado de Terreno                                 │
│  MARACUYA · Relaciones Humanas · Grado 1                      │
└─────────────────────────────────────────────────────────────┘

【 META - META 】
SOP No.    : HRC-1.02.11
Título     : Puesto: Encargado de Terreno (Groundskeeper)
...
### 【 PURPOSE - OBJETIVO 】
Definir al puesto que mantiene senderos, cortafuegos, corrientes perimetrales y estructuras del terreno.
`EN-[ Define the role that maintains trails, firebreaks, perimeter streams and ground structures. ]`
...
1. Cortafuegos descuidado deja las casas **EXPUESTAS AL FUEGO** ☠️.
...
```yaml
sop_id: HRC-1.02.11
title_es: "Puesto: Encargado de Terreno (Groundskeeper)"
dept: HRC
grade: 1
unit: "HRC-1.02"
tier: "T2"
