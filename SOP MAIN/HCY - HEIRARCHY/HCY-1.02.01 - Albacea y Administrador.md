...
### 【 PURPOSE - OBJETIVO 】
Definir el puesto de máxima autoridad, sus deberes y sus límites, para que todo el staff entienda de dónde vienen las decisiones finales.
`EN-[ Define the top authority role, its duties and limits, so all staff understand where final decisions come from. ]`

### 【 SCOPE - ALCANCE 】
Incluye: autoridad final, directriz ecológica, control de dinero, gobierno, legal y estrategia.
Excluye: tareas operativas diarias (las delega al Gerente de Operaciones).
...
- Investigador biodinámico, formador, arquitecto de sistemas, decisor de crisis, representante legal del patrimonio.

### 【 REASONING - RAZÓN 】
Por el estatus de albaceazgo, la autoridad y el dinero se concentran en una sola figura de máxima confianza. Esto protege el patrimonio de los herederos menores y evita fugas.
...
```yaml
sop_id: HRC-1.02.01
title_es: "Puesto: Albacea-Administrador"
dept: HRC
grade: 1
unit: "HRC-1.02"
tier: "T0"
