...
📌 **¿SABÍAS QUE?**
En un sitio remoto, la logística lo es todo. Un olvido en la compra semanal significa **DÍAS SIN EL INSUMO**, no una vuelta rápida a la tienda. Este puesto es la sangre que lleva recursos por el organismo.

`EN-[ In a remote site, logistics is everything. A missed weekly purchase means DAYS without the item, not a quick trip to the store. This role is the bloodstream carrying resources through the organism. ]`

### 【 PURPOSE - OBJETIVO 】
Definir quién asegura que la finca nunca se quede sin recursos, comprando a granel y organizando el transporte.
`EN-[ Define who ensures the property never runs out of resources, through bulk buying and transport routing. ]`
...
1. Un faltante mal planeado deja la cocina o el mantenimiento **SIN OPERAR POR DÍAS**.
...
```yaml
sop_id: HRC-1.02.04
title_es: "Puesto: Gerente de Logística"
dept: HRC
grade: 1
unit: "HRC-1.02"
tier: "T1"
