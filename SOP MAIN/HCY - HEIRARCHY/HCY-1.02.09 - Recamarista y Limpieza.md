...
### 【 PURPOSE - OBJETIVO 】
Definir al puesto que limpia y esteriliza las villas con métodos ecológicos y protege la separación de aguas.
`EN-[ Define the role that cleans and sterilizes villas with ecological methods and guards water separation. ]`
...
5. Proteger la privacidad del huésped. No tocar ni compartir datos 🔒.

**Puestos que puede asumir**
- Limpieza profunda, turnover, apoyo de lavandería, apoyo de recepción de villa, cuidado de amenidades.

### 【 CONSEQUENCE - CONSECUENCIA 】
1. Un producto prohibido al drenaje vivo **MATA LAS BACTERIAS DEL FILTRO** ⚠️ y daña los huertos.
